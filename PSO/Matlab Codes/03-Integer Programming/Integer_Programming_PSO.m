...
P=1000;
M=8;
CostFunction=@(x) MyCost(x, P, M);  % Cost Function
nVar=5;                       % Num of Decision Variables
VarSize=[1 nVar];             % Size of Decision Variables Matrix
VarMin=0;                     % Lower Bound of Variables
VarMax=1;                     % Upper Bound of Variables

%% PSO Parameters
MaxIt=100;    % Maximum Num of Iterations
...
% velocity Lower and Upper Bounds
VelMax=0.1*(VarMax-VarMin);
VelMin=-0.1*(VarMax-VarMin);

% Construction Coeffitients
% phi1=2.05;
% phi2=2.05;
% phi=phi1+phi2;
% chi=2/(phi-2+sqrt(phi^2-4*phi));
% w=chi;              % Inertial Weight
...
xlabel('Num of Function Evaluation');
ylabel('Best Cost');
